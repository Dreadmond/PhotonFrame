...
public:
    ...
    bool performUpdate() {
        ...
        if (httpCode == HTTP_CODE_OK) {
            ...
            if (contentLength > 0 && contentLength < (ESP.getFreeSketchSpace() - 0x1000)) {
                ...
                if (Update.begin(contentLength)) {
                    ...
                    while (written < contentLength) {
                        ...
                        size_t toRead = min((size_t)4096, (size_t)(contentLength - written));
...
public:
    ...
    bool checkAndUpdate() {
        if (checkForUpdate()) {
            Serial.println("GitHub OTA: New version found, updating...");
            return performUpdate();
        }
        return false;
    }
